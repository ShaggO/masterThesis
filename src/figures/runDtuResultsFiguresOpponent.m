...
%end
own = load('results/optimize/DTUparamsTestFinalOpponent.mat');
%% Load sift results
sifts = load('results/optimize/dogsift_opponent_test.mat');
...
displayDtuReportResults(plotROCAUC,plotPRAUC,pathTypes,'test',plotArgs,legends,'opponent_');

%% Results table
fid = fopen('table.txt','w');
dims = {'900/1050','600','1500/1650','384'};
