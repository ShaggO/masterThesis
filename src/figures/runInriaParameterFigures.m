...
yRanges = {[0.9 1],[0.8 0.9501]};
yRangeDims = {[0 12000],[0 12000]};
yRangeCellSigmaAlt = {[0.9 1],[0.8 0.9501]};
yRangeBinSigmaAlt = {[0.9 1],[0.8 0.9501]};
betas = [10, 11];
height = 3.5;
heightDims = 3;
...
%     plotLoggerResults(logger(betas(i)),'\beta',[name '_binSigma'],{},false,yRanges{i},height)
    ...
    plotLoggerResults(logger([6 7 8]),'\alpha',[name '_cellSigmaAlt'],{'G','Tri','Box','location','south'},false,yRangeCellSigmaAlt{i},height,false)
    plotLoggerResults(logger([9 10 11]),'\beta',[name '_binSigmaAlt'],{'G','Tri','Box','location','south'},false,yRangeBinSigmaAlt{i},height,false)
end
