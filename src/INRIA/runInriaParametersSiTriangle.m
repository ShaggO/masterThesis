...
diaryFile = ['results/optimize/inriaParametersSiTriangle_' strrep(datestr(now),':','-') '.out'];
diary(diaryFile)
disp('Optimization of parameters for SI (triangle bin filter) started.');
...
clear data;
save([optDir '/inriaParametersSiTriangle']);
