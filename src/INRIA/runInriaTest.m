...
%     'window',{'type','square','scales',1,'spacing',50,'windowSize',windowSize}, ...
%     'hog',{'numorientations',12}, ...
%     0,{'rx-'});
% method(3) = methodStruct( ...
%     'window',{'type','square','scales',1,'spacing',50,'windowSize',windowSize}, ...
%     'hog',{'numorientations',18}, ...
%     0,{'rx-'});
...
totalTime = tic;
svmPath = inriaTestSvm(method,svmArgs,true,10,1*10^4);
% data = inriaData;
% [PRAUC] = inriaCrossValidateSvm(data,6,method,svmArgs,true); PRAUC
