...
switch m.descriptor
    ...
    case 'ghist'
        ...
        desName = sprintf('ghist-%s-%s-%s-%s-%s-%s-%s-%s-%s-%s',...
                    num2str(r.blockSize(1)),...
                    num2str(r.blockSize(2)),...
                    num2str(r.cellSize(1)),...
                    num2str(r.cellSize(2)),...
                    r.spatialType,...
                    ...
                    num2str(r.binSigma),...
                    num2str(r.binCount));
        desFunc = @(I,F) getGHistDescriptors(I,F,r.blockSize,r.cellSize, ...
