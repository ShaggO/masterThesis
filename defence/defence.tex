...
\centering
	...
	\end{subfigure}
	\begin{subfigure}[t]{0.40\textwidth}
		\includegraphics[width=\textwidth, clip=true, trim=1 1 1 1]{img/shoeDescriptorZoom2.pdf}
	\end{subfigure}
\end{figure}
\end{frame}
%
...
\centering
	...
	\end{subfigure}
	\begin{subfigure}[t]{0.40\textwidth}
		\includegraphics[width=\textwidth, clip=true, trim=1 1 1 1]{img/shoeDescriptorZoom3.pdf}
	\end{subfigure}
\end{figure}
\end{frame}
%
