...
\begin{figure}
	...
	\label{fig:hogDescriptorExample}
\end{figure}
%\restoregeometry
...
\centering
	\centerline{\begin{subfigure}[t]{0.593\textwidth}
		\includegraphics[width=\textwidth]{img/inriaParameters_cellSpacing.pdf}
		\caption{Cell spacing $r$}
		\label{fig:inriaParameters_cellSpacing}
	\end{subfigure}
	\begin{subfigure}[t]{0.593\textwidth}
		\centering
		\includegraphics[width=\textwidth]{img/inriaParameters_binCount.pdf}
		\caption{Bin count $n$}
		\label{fig:inriaParameters_binCount}
	\end{subfigure}}
	\centerline{\begin{subfigure}[t]{0.593\textwidth}
		\includegraphics[width=\textwidth]{img/inriaParameters_cellSigma.pdf}
		\caption{Cell scale $\alpha$}
		\label{fig:inriaParameters_cellSigma}
		\vspace{2mm}
	\end{subfigure}
	\begin{subfigure}[t]{0.593\textwidth}
		\centering
		\includegraphics[width=\textwidth]{img/inriaParameters_binSigma.pdf}
		\caption{Bin scale $\beta$}
		\label{fig:inriaParameters_binSigma}
	\end{subfigure}}
	\centerline{\begin{subfigure}[t]{0.593\textwidth}
		\centering
		\includegraphics[width=\textwidth]{img/inriaParameters_normSigma.pdf}
		\caption{Normalization scale $\eta$}
		\label{fig:inriaParameters_normSigma}
		\vspace{2mm}
	\end{subfigure}
	\begin{subfigure}[t]{0.593\textwidth}
		\centering
		\includegraphics[width=\textwidth]{img/inriaParameters_logC.pdf}
		\caption{SVM weight $C$}
		\label{fig:inriaParameters_logC}
		\vspace{2mm}
	\end{subfigure}}
	\caption{Parameter study results for GO.}
	\label{fig:inriaParametersAuc}
	\vspace{1cm}
	\centerline{\begin{subfigure}[t]{0.593\textwidth}
		\centering
		\includegraphics[width=\textwidth]{img/inriaParameters_cellSpacingDims.pdf}
		\caption{Cell spacing $r$}
		\label{fig:inriaParameters_cellSpacingDims}
	\end{subfigure}
	\begin{subfigure}[t]{0.593\textwidth}
		\centering
		\includegraphics[width=\textwidth]{img/inriaParameters_binCountDims.pdf}
		\caption{Bin count $n$}
		\label{fig:inriaParameters_binCountDims}
		\vspace{2mm}
	\end{subfigure}}
	\caption{Parameter study results for GO.}
	\label{fig:inriaParametersDims}
\end{figure}
%
\begin{figure}[p]
\centering
	\centerline{\begin{subfigure}[t]{0.593\textwidth}
		\includegraphics[width=\textwidth]{img/inriaParametersSi_gridSize.pdf}
		\caption{Cell spacing $r$}
		\label{fig:inriaParametersSi_gridSize}
	\end{subfigure}
	\begin{subfigure}[t]{0.593\textwidth}
	...
	\label{fig:imageCorrespondenceCurvesSi}
\end{figure}
%
%\begin{table}[tb]
%\centering
...
\bottomrule
\end{tabular}
\caption{Parameter study optimal C parameter from 6-fold cross validation for GO, SI, GoSi, Hog, and HogDT}
\label{fig:INRIAparams}
\end{table}
%
\begin{table}
