...
By comparing the PR AUCs with and without retraining of hard negatives, we see that all descriptors benefit from retraining. Interestingly, compact GO+SI starts off worse than the much larger GO+SI, but it overtakes after retraining by adding more than twice the amount of hard negatives. \todo{reference discussion?}
