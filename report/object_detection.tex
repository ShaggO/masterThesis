...
This formulation can be extended to a non-linear SVM by replacing $\w \cdot \x_i$ with a kernel function $k(\w,\x_i)$. Examples of alternative kernels are polynomials and Gaussian radial basis functions:
\todo{Define alternative kernels}
