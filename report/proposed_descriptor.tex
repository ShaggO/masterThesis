...
\begin{figure}[p]
    ...
    \caption{Interest points (green) found by a multi-scale DoG detector on an example image. The size of the circles illustrates the detection scale of each point. $529$ points are detected in total.}
