...
%   	\begin{subfigure}[t]{0.1\textwidth}
    ...
    \begin{subfigure}[t]{\textwidth}
    \centering
       	\includegraphics[width=0.1\textwidth]{img/cellHistFigureSiExample1.png}
    	\includegraphics[width=0.1\textwidth]{img/cellHistFigureSiExample2.png}
    	\includegraphics[width=0.1\textwidth]{img/cellHistFigureSiExample3.png}
    	\includegraphics[width=0.1\textwidth]{img/cellHistFigureSiExample4.png}
    	\includegraphics[width=0.1\textwidth]{img/cellHistFigureSiExample5.png}
    	\includegraphics[width=0.1\textwidth]{img/cellHistFigureSiExample6.png}
    	\includegraphics[width=0.1\textwidth]{img/cellHistFigureSiExample7.png}
    	\includegraphics[width=0.1\textwidth]{img/cellHistFigureSiExample8.png}
    	\caption{ok}
    	\label{fig:cellHistFigureSiExample}
   	\end{subfigure}
