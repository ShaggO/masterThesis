...
The results of our parameter study for our GO and SI descriptors are shown in \Cref{fig:ICparamsGo,fig:ICparamsSi} respectively.
%
\begin{table}[tb]
\pgfplotstableset{
...
\centering
	...
	\begin{subfigure}[t]{0.593\textwidth}
		\centering
		\includegraphics[width=\textwidth]{img/dtuParametersGo_binCountDims.pdf}
		\caption{Bin count $n$}
		\label{fig:dtuParametersGo_binCountDims}
		\vspace{2mm}
	\end{subfigure}}
	\caption{Parameter study results for GO.}
...
\section{Results}
%
PR results: \Cref{fig:dtuResultsPR}
ROC results: \Cref{fig:dtuResultsROC}
...
\begin{figure}[tb]
	\centerline{
	\begin{subfigure}[t]{0.6242\textwidth}
		\includegraphics[width=\textwidth]{img/dtuResultsStats_1.pdf}
		\caption{Arc 1}
		\label{fig:dtuResultsStatsarc1}
	\end{subfigure}
	\begin{subfigure}[t]{0.5618\textwidth}
		\includegraphics[width=\textwidth]{img/dtuResultsStats_2.pdf}
		\caption{Arc 2}
	...
	\centerline{
	\begin{subfigure}[t]{0.6242\textwidth}
		\includegraphics[width=\textwidth]{img/dtuResultsStats_3.pdf}
		\caption{Arc 3}
		\label{fig:dtuResultsStatsarc3}
	\end{subfigure}
	\begin{subfigure}[t]{0.5618\textwidth}
		\includegraphics[width=\textwidth]{img/dtuResultsStats_4.pdf}
		\caption{Linear path}
	...
	\centerline{
	\begin{subfigure}[t]{0.6242\textwidth}
		\includegraphics[width=\textwidth]{img/dtuResultsStats_5.pdf}
		\caption{Light path, $x$-axis}
		\label{fig:dtuResultsStatsxAxis}
	\end{subfigure}
	\begin{subfigure}[t]{0.5618\textwidth}
		\includegraphics[width=\textwidth]{img/dtuResultsStats_6.pdf}
		\caption{Light path, $z$-axis}
		\label{fig:dtuResultsStatszAxis}
	\end{subfigure}
	}
	\caption{Confidence intervals on the PR AUC difference between our GO descriptor and SIFT. A positive difference denotes that our GO descriptor outperforms SIFT. If the confidence interval for a position contains zero, there is no significant difference in performance.}
