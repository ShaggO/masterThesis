...
Notes: PR-curves better than the corresponding ROC-curves. Use PR curves for the discussion below:
Linear path: Generally worse than SIFT
Arcs: better at higher perspective distortion degrees. Effect correlated with distance results.
Light paths: Generally better than SIFT.

Statistics 95 confidence interval: Only significantly better than SIFT on the outermost $x$-axis light positions. Same for GO and SIFT.
GO, GO+SI significantly better than SI.
SIFT not significantly better than any.

SI always worse than GO and often worse than SIFT.

GO+SI marginally better than GO on light variations but almost identical to GO otherwise.
