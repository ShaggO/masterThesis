...
\caption{Matches with score under $t = 0.8$}
...
\begin{figure}
\centering
\includegraphics[width=0.5\textwidth]{img/imageCorrespondenceROC.pdf}
\caption{ROC-curve}
\label{fig:imageCorrespondenceROC}
\includegraphics[width=0.5\textwidth]{img/imageCorrespondencePR.pdf}
\caption{PR-curve}
