...
The optimal parameters for our GO and SI descriptors are shown in \Cref{fig:ICparamsGo,fig:ICparamsSi} respectively.
...
\bottomrule
\end{tabular}}
\caption{Optimized parameters from our parameter study for SI.}
...
\centering
	...
	\begin{subfigure}[t]{0.593\textwidth}
		...
		\vspace{2mm}
	\end{subfigure}}
	\caption{Average matching performance on training data for GO when adjusting the parameters. Optimal parameter values are marked with a cross.}
...
\bottomrule
\end{tabular}
\caption{Average matching performance on training data for GO when adjusting the cell layout parameters. Optimal performance is marked in bold.}
...
\bottomrule
\end{tabular}
\caption{Average matching performance on training data for SI when adjusting the cell layout parameters.}
