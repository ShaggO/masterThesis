...
\centering
	...
	\end{subfigure}}
	\centerline{\begin{subfigure}[t]{0.593\textwidth}
		\includegraphics[width=\textwidth]{img/dtuParametersGo_cellSigma.pdf}
		\caption{Cell scale $\alpha$ (Gaussian kernel)}
		\label{fig:dtuParametersGo_cellSigma}
		\vspace{2mm}
	\end{subfigure}
	\begin{subfigure}[t]{0.593\textwidth}
		\centering
		\includegraphics[width=\textwidth]{img/dtuParametersGo_binSigma.pdf}
		\caption{Bin scale $\beta$ (Gaussian kernel)}
...
When looking at the three arc graphs (\Cref{fig:dtuResultsPRarc1,fig:dtuResultsPRarc2,fig:dtuResultsPRarc3}), we see that GO and GO+SI performance drops less than SIFT when the camera is moved towards the outermost positions. The advantage over SIFT is however lower for arc 2 and 3 than arc 1. This is likely caused by a correlation with the performance over scaling variations as shown in \Cref{fig:dtuResultPRlinear}, where SIFT performs better than any of our descriptors.

For light variations (\Cref{fig:dtuResultsPRxAxis,fig:dtuResultsPRzAxis}) our GO and GO+SI descriptors are better than SIFT.

Having inspected the graphs for mean PR AUCs, we are now interested in knowing whether the descriptors are statistically significantly different. We therefore perform a paired $t$-test as described in \Cref{sec:pairedTtest} on each of the path positions. The resulting 95\% confidence interval graphs on the difference between our GO+SI descriptor and SIFT are show in \Cref{fig:dtuResultsStats}. As we see from the graphs, the confidence intervals cross 0 for all positions apart from the outermost positions of the $x$-light path. In other words we cannot conclude that GO+SI and SIFT are significantly different except on the three outermost positions of the $x$-light path (one on the left and two on the right side).

Performing paired $t$-tests between other combinations of the GO, SI, GO+SI, and SIFT descriptors reveal that GO and GO+SI are significantly better than SI, and that we cannot conclude that neither SIFT is significantly better than any of our descriptors nor that GO and GO+SI are significantly different.

\begin{figure}[tb]
	\centerline{
		\includegraphics[width=1.2\textwidth]{img/dtuResults_legend_cropped.pdf}
	}	
	\centerline{
	\begin{subfigure}[t]{0.6242\textwidth}
		\includegraphics[width=\textwidth]{img/dtuResultsPR_1.pdf}
		\caption{Arc 1}
		\label{fig:dtuResultsPRarc1}
	\end{subfigure}
	\begin{subfigure}[t]{0.5618\textwidth}
		\includegraphics[width=\textwidth]{img/dtuResultsPR_2.pdf}
		\caption{Arc 2}
	...
	\centerline{
	\begin{subfigure}[t]{0.6242\textwidth}
		\includegraphics[width=\textwidth]{img/dtuResultsPR_3.pdf}
		\caption{Arc 3}
		\label{fig:dtuResultsPRarc3}
	\end{subfigure}
	\begin{subfigure}[t]{0.5618\textwidth}
		\includegraphics[width=\textwidth]{img/dtuResultsPR_4.pdf}
		\caption{Linear path}
	...
	\centerline{
	\begin{subfigure}[t]{0.6242\textwidth}
		\includegraphics[width=\textwidth]{img/dtuResultsPR_5.pdf}
		\caption{Light path, $x$-axis}
		\label{fig:dtuResultsPRxAxis}
	\end{subfigure}
	\begin{subfigure}[t]{0.5618\textwidth}
		\includegraphics[width=\textwidth]{img/dtuResultsPR_6.pdf}
...
\begin{figure}[tb]
	...
	\centerline{
	\begin{subfigure}[t]{0.6242\textwidth}
		\includegraphics[width=\textwidth]{img/dtuResultsROC_1.pdf}
		\caption{Arc 1}
		\label{fig:dtuResultsROCarc1}
	\end{subfigure}
	\begin{subfigure}[t]{0.5618\textwidth}
		\includegraphics[width=\textwidth]{img/dtuResultsROC_2.pdf}
		\caption{Arc 2}
	...
	\centerline{
	\begin{subfigure}[t]{0.6242\textwidth}
		\includegraphics[width=\textwidth]{img/dtuResultsROC_3.pdf}
		\caption{Arc 3}
		\label{fig:dtuResultsROCarc3}
	\end{subfigure}
	\begin{subfigure}[t]{0.5618\textwidth}
		\includegraphics[width=\textwidth]{img/dtuResultsROC_4.pdf}
		\caption{Linear path}
	...
	\centerline{
	\begin{subfigure}[t]{0.6242\textwidth}
		\includegraphics[width=\textwidth]{img/dtuResultsROC_5.pdf}
		\caption{Light path, $x$-axis}
		\label{fig:dtuResultsROCyAxis}
	\end{subfigure}
	\begin{subfigure}[t]{0.5618\textwidth}
		\includegraphics[width=\textwidth]{img/dtuResultsROC_6.pdf}
		\caption{Light path, $z$-axis}
