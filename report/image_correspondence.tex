...
Having established the matching strategy and similarity measure, we will now describe two performance measures, which we will use for evaluation of our descriptor as well as competing descriptors.
...
\begin{table}
	...
	\begin{tabular}{|l|c|c|}
		...
		Assigned positive & \cellcolor{green!25}Positive True & \cellcolor{red!25} False Negative  \\ \hline
		Assigned negative & \cellcolor{red!25} False Positive & \cellcolor{green!25} True Negative \\ \hline
	\end{tabular}
	\egroup
