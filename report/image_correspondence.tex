...
From these three measurements we further derive the two performance measures: Receiver operating characteristic (\ROC), which is the recall vs. fall-out, and \PR \todo{Come up with name for recall vs. fall-out}, which is recall vs. 1-precision.
