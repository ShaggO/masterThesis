...
\begin{figure}
	...
	\caption{Illustration of the shape index}
\end{figure}

\begin{align}
S &= \frac{2}{\pi} \Atan{\frac{-L_{xx} - L_{yy}}{\sqrt{4 L_{xy}^2 + (L_{xx} - L_{yy})^2}}} \\
C &= \frac12 \sigma^2 \sqrt{L_{xx}^2 + 2 L_{xy}^2 + L_{yy}^2}
\end{align}
