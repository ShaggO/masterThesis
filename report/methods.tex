...
The \emph{Gaussian derivatives} $G_{x^m y^n}$, where $m$ is the order of derivations in the $x$-axis and $n$ is the order of derivations in the $y$-axis, are used for obtaining structural information from an image.
...
\begin{figure}[tb]
	\centering
	\includegraphics[width=0.8\textwidth,clip=true,trim=31 0 0 0]{img/gradientOrientationTheory.pdf}
...
\begin{figure}
	\centering
	\includegraphics[width=0.8\textwidth,clip=true,trim=31 0 0 0]{img/shapeIndexTheory.pdf}
