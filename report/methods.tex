...
%
\begin{figure}
\includegraphics[scale=0.2]{img/cellLayoutSquare.png}
\caption{Square layout of cells.}
\end{figure}
%
\begin{figure}
\includegraphics[scale=0.2]{img/cellLayoutPolar.png}
\caption{Polar layout of cells.}
\end{figure}
%
\begin{figure}
\includegraphics[scale=0.2]{img/cellLayoutConcentricPolar.png}
\caption{Concentric polar layout of cells.}
\end{figure}
%
