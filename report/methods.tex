...
\begin{figure}[p]
	\centering
	\includegraphics[width=0.64\textwidth,clip=true,trim=31 0 0 0]{img/gradientOrientationTheory.pdf}
	...
	\includegraphics[width=0.64\textwidth,clip=true,trim=31 0 0 0]{img/shapeIndexTheory.pdf}
