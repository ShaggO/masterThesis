...
\end{align}
%
The specifics of the histograms used in our work will be explained in \Cref{eq:proposed_histogram}.
%
...
An example of DoG images is shown in \Cref{fig:dogExample}, which is based on the scale-space images from \Cref{fig:scaleSpaceExample}. Note that the two different scales locate dark and light blobs of different sizes.
